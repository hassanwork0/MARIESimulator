...
public class TextFileViewerNew extends JFrame {
/******************************************************************************************
...
/* --                                                                                 -- */
  ...
  JButton     printButton = new JButton("Print");       //   ... the print button.
  boolean     exitOnClose = true;                       // Do we just return to caller 
                                                        //       when done?

  public TextFileViewerNew(String frameTitle, String aTextFile, boolean exitMode) {
/******************************************************************************************
...
******************************************************************************************/
    ...
    try {                                             // Try to open the input.
      in = this.getClass().getResourceAsStream(aTextFile);
...
******************************************************************************************/
  ...
  try {                                                 // Create the output listing.
    tempFile = new BufferedWriter( new FileWriter("temp.txt") );
  } // try
  catch (IOException e) {
   ...
   try { 
           ...
           tempFile.write(displayArea.getText());
           tempFile.write(formFeed);
           tempFile.close();
...
//     DocFlavor flavor = DocFlavor.STRING.TEXT_PLAIN.getMimeType();
//     DocFlavor flavor = DocFlavor.STRING.TEXT_PLAIN;
//     flavor.getMimeType(DocFlavor.STRING.TEXT_PLAIN);  
//     DocFlavor flavor = DocFlavor.STRING; 
//     DocFlavor flavor = new DocFlavor.STRING("text/plain");     
//     Doc doc = new SimpleDoc(displayArea.getText(), flavor, null); 
//       DocAttributeSet das = new HashDocAttributeSet();
//     Doc doc = new SimpleDoc(displayArea.getText(), DocFlavor.STRING.TEXT_PLAIN, null); 
//     Doc doc = new SimpleDoc(displayArea.getText(), DocFlavor.STRING.TEXT_PLAIN, das); 
     PrintRequestAttributeSet pras = new HashPrintRequestAttributeSet(); 
     PrintService printService [] = PrintServiceLookup.lookupPrintServices(flavor,pras); 
//     PrintService defaultService [] = PrintServiceLookup.lookupPrintServices(null, null); 
...
//          StringReader fis = new StringReader(s); 
//         fis.read(ca, 0, 100); 
// System.out.println(s+ca[0]+ca[1]+ca[2]+ca[3]+ca[4]+ca[5]+ca[6]+ca[7]+"*");   
// System.out.println(ca);       
          DocAttributeSet das = new HashDocAttributeSet(); 
          Doc doc = new SimpleDoc(fis, flavor, das); 
//          Doc doc = new SimpleDoc(s, flavor, das); 
...
******************************************************************************************/
    TextFileViewerNew tfv = new TextFileViewerNew(frameTitle, aTextFile, exitMode);
    tfv.show();
  } // showFile()
...
******************************************************************************************/
    ...
    TextFileViewerNew tfv = new TextFileViewerNew(args[0], args[1], true);
    tfv.show();
  } // main()
} // TextFileViewer